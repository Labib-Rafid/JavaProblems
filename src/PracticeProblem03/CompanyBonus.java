...
public class CompanyBonus {
    public static void main(String[] args) {
        ...
        int bonus;
        if(targetSales >= 95 && attendence == 100) bonus = 60;
        else if(targetSales >= 95 && attendence >= 90) bonus = 40;
        else if(targetSales >= 80 && attendence == 100) bonus = 40;
        else if(targetSales >= 80 && attendence >= 90) bonus = 20;
        else bonus = 5;
